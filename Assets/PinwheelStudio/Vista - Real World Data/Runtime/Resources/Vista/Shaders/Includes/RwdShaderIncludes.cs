...
{
    public static class RwdShaderIncludes
    {
        ...
        private static void GenerateIncludesFile()
        {
            ...
            string filePath = Path.Combine(directory, $"{typeof(RwdShaderIncludes).Name}.hlsl");
            string[] includeFilePaths = GetAllIncludeFilePaths();
            StringBuilder text = new StringBuilder();
            text.AppendLine("//This file was generated, don't edit by hand")
                .AppendLine("#ifndef VISTA_RWD_SHADER_INCLUDES")
                .AppendLine("#define VISTA_RWD_SHADER_INCLUDES")
                .AppendLine();
        ...
        {
            string[] guids = AssetDatabase.FindAssets($"t:Script {typeof(RwdShaderIncludes).Name}");
