...
namespace TPSBR.UI
{
        using ItemVendor = TPSBR.ItemVendor;
        ...
        public sealed class UIVendorView : UICloseView, IUIItemSlotOwner
        {
                ...
                [SerializeField]
                private string _noDefinitionsText = "Vendor has nothing to sell.";
                [SerializeField]
                ...
                private ItemVendor.VendorItemStatus _lastStatus = ItemVendor.VendorItemStatus.NoItems;
                ...
                protected override void OnClose()
                {
                        ...
                        _currentItems.Clear();
                        _lastItems.Clear();
                        _lastStatus = ItemVendor.VendorItemStatus.NoItems;
                        _selectedIndex = -1;
                        ClearSlots();
                ...
                private void RefreshItemSlots(bool force)
                {
                        ...
                        ItemVendor.VendorItemStatus status = ItemVendor.VendorItemStatus.NoItems;
