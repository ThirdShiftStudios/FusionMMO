...
namespace TPSBR.UI
{
    public class UIWeapons : UIBehaviour
    {
        ...
        [SerializeField] private CanvasGroup _weaponGroup;
        [SerializeField] private TextMeshProUGUI _magazineAmmo;
        [SerializeField] private TextMeshProUGUI _weaponAmmo;
        [SerializeField] private Image _weaponIcon;
        [SerializeField] private Image _weaponIconShadow;
        [SerializeField] private TextMeshProUGUI _weaponName;
        [SerializeField] private TextMeshProUGUI _weaponClass;
        [SerializeField] private Image _ammoProgress;
        [SerializeField] private string _reloadingText = "-";
        [SerializeField] private CanvasGroup _unarmedThumbnail;
        [SerializeField] private CanvasGroup _secondaryThumbnail;
        [SerializeField] private Image _secondaryThumbnailIcon;
        [SerializeField] private CanvasGroup _primaryThumbnail;
        [SerializeField] private Image _primaryThumbnailIcon;
        [SerializeField] private CanvasGroup _grenadesThumbnail;
        [SerializeField] private CanvasGroup _grenadeChangingGroup;
        [SerializeField] private float _thumbnailInactiveAlpha = 0.3f;
        [SerializeField] private Color _grenadeChangingColor = Color.yellow;
        [SerializeField] private Color _grenadeInactiveColor = Color.gray;
        [SerializeField] private Image[] _grenades;

        private static readonly WeaponSize[] SecondaryWeaponSizes = { WeaponSize.Unarmed };
        private static readonly WeaponSize[] PrimaryWeaponSizes = { WeaponSize.Staff };
        ...
        {
            return;
            UpdateWeaponThumbnail(inventory, _secondaryThumbnail, _secondaryThumbnailIcon, SecondaryWeaponSizes,
                ref _lastSecondaryID);
            UpdateWeaponThumbnail(inventory, _primaryThumbnail, _primaryThumbnailIcon, PrimaryWeaponSizes,
                ref _lastPrimaryID);
            ...
            bool isSecondary = currentWeaponSize == WeaponSize.Staff;
            _secondaryThumbnail.alpha = isSecondary ? 1f : _thumbnailInactiveAlpha;
            _primaryThumbnail.alpha = currentWeaponSize == WeaponSize.Staff ? 1f : _thumbnailInactiveAlpha;
        ...
        private void UpdateWeaponThumbnail(Inventory inventory, CanvasGroup thumbnail, Image weaponIcon,
            WeaponSize[] sizes, ref NetworkId lastWeaponID)
        {
            Weapon weapon = null;
