...
namespace TPSBR
{
    ...
    public sealed partial class AgentInput : ContextBehaviour, IBeforeTick, IAfterAllTicks
    {
        ...
        [SerializeField]
        [Range(0.0f, 1.0f)]
        [Tooltip("How long the last known input is repeated before using default.")]
        private float _maxRepeatTime = 0.25f;
        [SerializeField]
        [Tooltip("Outputs missing inputs to console.")]
        ...
        private bool IsLoadingSceneActive()
        {
            ...
            UnityEngine.SceneManagement.Scene loadingScene = SceneManager.GetSceneByName(loadingSceneName);
