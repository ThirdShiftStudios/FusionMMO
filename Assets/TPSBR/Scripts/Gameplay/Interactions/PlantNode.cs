...
namespace TPSBR
{
    public sealed class PlantNode : NetworkBehaviour, IInteraction
    {
        [Header("Interaction")]
        [SerializeField] private string _interactionName = "Harvest Plant";
        [SerializeField, TextArea] private string _interactionDescription = "Hold interact to harvest this plant.";
        [SerializeField] private Transform _hudPivot;
        [SerializeField] private Collider _interactionCollider;

        [Header("Harvesting")]
        [SerializeField, Tooltip("Time in seconds the player needs to harvest before the plant is depleted.")]
        private float _requiredHarvestTime = 2f;
        [SerializeField, Tooltip("Optional respawn time. Set to zero to keep the plant depleted once harvested.")]
