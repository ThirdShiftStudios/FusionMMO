namespace TPSBR
{
    ...
    public sealed class Inventory : NetworkBehaviour, IBeforeTick
    {
        ...
        private void MoveItem(byte fromIndex, byte toIndex)
        {
            ...
            if (fromPickaxe == false && fromWoodAxe == false && fromIndex >= _items.Length)
                return;

            if (toPickaxe == false && toWoodAxe == false && toIndex >= _items.Length)
                return;
            ...
            if (fromPickaxe == true)
            {
                ...
                if (toPickaxe == true || toWoodAxe == true)
                    return;
            ...
            if (fromWoodAxe == true)
            {
                ...
                if (toWoodAxe == true || toPickaxe == true)
                    return;
        ...
        private bool RemoveInventoryItemInternal(int index, byte quantity)
        {
            ...
            bool removedWoodAxe = IsWoodAxeSlotItem(inventorySlot);
