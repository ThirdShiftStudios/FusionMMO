...
namespace UnityEditor.AzureSky
{
    ...
    public class AzureThunderPrefabEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            GUI.Label(new Rect(m_controlRect.x + 38f, m_controlRect.y + 17f, m_controlRect.width, 22f), "Script Version 1.0.0  |  Asset Version 8.0.5", EditorStyles.whiteMiniLabel);
