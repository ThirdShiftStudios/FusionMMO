...
namespace AquariusMax.Water.demo
{
    // influenced by Unity
    ...
    public class DemoCharacter : MonoBehaviour
    {
       ...
       // bool isGrounded = true;
        ...
        void Update()
        {
            ...
            if (jumpPressed && charControl.isGrounded)
            {
                move.y = jumpSpeed;
                jumpPressed = false;
                isJumping = true;
        ...
        private void FixedUpdate()
        {
            ...
            if (charControl.isGrounded && !isJumping)
            {
                move.y = -landingForce;
            }
            else
        ...
        private void OnTriggerStay(Collider other)
        {
            if (other.gameObject.layer == 4 && VelocityXZ > 0.02f && Time.renderedFrameCount % 5 == 0)
            {
                ...
                CreateRipple(y-100, y+100, 3, 5, 2, 1);
            }
        }
